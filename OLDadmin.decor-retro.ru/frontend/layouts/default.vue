...
<script>
    ...
    import OffcanvasToolbar from '../components/Layout/OffcanvasToolbar.vue'
    ...
    export default {
        ...
        head() {
            return {
                bodyAttrs: {
                    class: 'kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-page--loading' //how to get classes already setted in default.vue like my has-navbar-fixed-top class
                }
            }
        },
        data() {
