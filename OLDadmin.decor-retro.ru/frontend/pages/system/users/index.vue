                ...
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">
                            Пользователи
                            <small>вывод всех пользователей админки </small>
                        </h3>
                    </div>
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper" v-if="$permission(['*'])">
                            <n-link :to="{name: 'system-users-create'}" class="btn btn-brand btn-bold btn-upper btn-font-sm">
    ...
    export default {
        ...
        data() {
            return {
                ...
                //DataTable
                url: '/users',
                itemRouteNameEdit: 'system-users-id',
                permissionEdit: ['*'],
                permissionShow: ['*'],
            };
        },
