                    ...
                    <div class="kt-portlet">
                        <div class="kt-portlet__head">
                              <div class="kt-portlet__head-label">
                                    <n-link :to="{name: 'orders' }" class="btn btn-secondary"><i class="fa fa-arrow-left" aria-hidden="true"></i>
                                        В таблицу
                                    </n-link>
                                </div>
                        </div>
                                ...
                                <div class="row">
                                  <div class="col-md-4">
                                        <div class="form-group ">
                                            ...
                                            class="form-control fixed-select" filterable placeholder="Выберите статус">
                                                <el-option
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            <tr class="font-weight-boldest" v-for="item, index in orderData">
                                                                ...
                                                                <td class="text-danger pr-0 pt-7 text-right">{{item.price}}
                                                                </td>
    ...
    export default {
        ...
        data() {
            return {
                ...
                bouquets: [],
                flowers: [],
                statuses: ['обработан ( не оплачен )', 'обработан ( оплачен )', 'передан исполнителю', 'принят исполнителем', 'доставлен', 'на удержании'],
